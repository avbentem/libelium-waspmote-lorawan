...
## Project contents
 ...
 - [src/waspmote-otaa](./src/WaspmoteOTAA): the actual sketch and its dependencies.
...
The values are sent in an 19 bytes MSB format. All values, except the battery level, are 16 bits signed integers where
